...
namespace revit_mcp_plugin.Core
{
    ...
    public class CommandManager
    {
        ...
        public void LoadCommands()
        {
            ...
            foreach (var commandConfig in _configManager.Config.Commands)
            {
                try
                {
                    ...
                    // Replace the version placeholder in paths.
        ...
        /// <summary>
        /// Loads a specific command from a specific assembly.
        /// </summary>
        ...
        private void LoadCommandFromAssembly(CommandConfig config)
        {
            try
            {
                ...
                {
                    // If the path is not absolute, resolve it relative to the Commands directory.
                        ...
                        !type.IsAbstract)
                    {
                        try
                        {
                            ...
                            if (command.CommandName == config.CommandName)
                            {
                                ...
                                _logger.Info("Created command instance [{0}]: {1}",
