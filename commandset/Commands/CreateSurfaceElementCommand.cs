    ...
    public class CreateSurfaceElementCommand : ExternalEventCommandBase
    {
        ...
        public override object Execute(JObject parameters, string requestId)
        {
            try
            {
                ...
                if (data == null)
                    throw new ArgumentNullException(nameof(data), "The data provided by the AI is null.");
                ...
                {
                    throw new TimeoutException("The operation to create surface-based elements timed out.");
                }
            }
            catch (Exception ex)
            {
